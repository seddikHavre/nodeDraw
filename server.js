...
wss.on('connection', function(client, request) {
  ...
  client.on('message', function(message) {
   ...
   //wss.broadcast(message+";"+cli);
  
   listDraw[cli]=decodeURIComponent(wsname)+"="+message;
   
   //console.log(listDraw[cli])
    //listDraw.forEach(Element=>{
      
      wss.broadcast(listDraw[cli])
   // })
